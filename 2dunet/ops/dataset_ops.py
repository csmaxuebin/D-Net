...
if __name__ == "__main__":
    imgs = np.load("E:/code/covid-19-detection/2dunet/NCOV-BF/NpyData/n01-00000.npy")
    #自己加的
    mask = np.load("E:/code/covid-19-detection/2dunet/NCOV-BF/NpyData/n01_lung_mask.npy")
    Rand_Transforms(imgs,mask)
