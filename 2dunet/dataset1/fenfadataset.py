...
class CTDataset(data.Dataset):
    def __init__(self, sa,data_home="",split="train",sample_number=4):
...
if __name__ == "__main__":
    ...
    ctd = CTDataset(data_home="../NCOV-BF", split="train", sample_number=4,sa=0.5)
    length = len(ctd)
    ctd[10]
